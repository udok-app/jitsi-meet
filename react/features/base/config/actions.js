...
/**
 * Signals that the configuration (commonly known in Udok Vídeo as config.js)
...
/**
 * Signals that a configuration (commonly known in Udok Vídeo as config.js)
...
/**
 * Stores a specific Udok Vídeo config.js object into {@code localStorage}.
 *
 * @param {string} baseURL - The base URL from which the config.js was
 * downloaded.
 * @param {Object} config - The Udok Vídeo config.js to store.
 * @returns {Function}
 */
